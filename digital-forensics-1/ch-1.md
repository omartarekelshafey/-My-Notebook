...
<table><thead><tr><th width="249.9998779296875">Section</th><th>Explanation</th></tr></thead><tbody><tr><td><strong>What is Forensic Science</strong></td><td>علم بيستخدم الطرق العلمية لتحليل الأدلة (زي DNA، بصمات، أسلحة) عشان يكشف الحقايق ويربط الجريمة بالفاعل.</td></tr><tr><td><strong>Why Digital Forensics</strong></td><td><p>المجرمين بقوا يستخدموا التكنولوجيا في الجرائم (اختراق، ابتزاز، سرقة</p><p>بيانات...)</p><p>فا علشان كده ال trace evidence اتغير يعني في اول كنت بدور علي شعر بصمة رجل الحاجات في digital forensics بتشوف ال meta data او logs وغيره من Artifact مش شرط يكون الحاجات ديه علي جهاز كومبيوتر بس علي اي جهاز عامتا</p></td></tr><tr><td><strong>Power of Digital Forensics</strong></td><td><p>Digital forensics can support in revealing crimes and tracking traces such as:• <strong>Fraud (الاحتيال):</strong> كشف عمليات نصب مالي وتحويلات غير مشروعة.</p><p>• <strong>Child Exploitation (استغلال الأطفال):</strong> تتبع الشبكات اللي بتستغل الأطفال على الإنترنت.</p><p>• <strong>Terrorism (الإرهاب):</strong> تحليل اتصالات ورسائل المجموعات الإرهابية.</p><p>• <strong>Drug Trafficking (تهريب المخدرات):</strong> تتبع الصفقات والاتصالات المشبوهة عبر الإنترنت.</p><p>• <strong>Homicide (جرائم القتل):</strong> استخراج داتا من موبايلات أو أجهزة المجرمين أو الضحايا لتوضيح ملابسات الجريمة.</p></td></tr></tbody></table>
